<?php
/**
 * Actosdb functions and definitions
 *
...
if ( ! function_exists( 'twentyten_admin_header_style' ) )
  {
    ...
    function twentyten_admin_header_style() {
      echo "<style type=\"text/css\" id=\"twentyten-admin-header-css\">
...
function twentyten_excerpt_length( $length = 40 )
{
  /***
...
function twentyten_comment( $comment, $args, $depth ) {
	...
	echo "<li class=\"post pingback\">
		<p>". _e( 'Pingback:', 'twentyten' ) .  comment_author_link() . edit_comment_link( __( '(Edit)', 'twentyten' ), ' ' ) . "</p>";
