			...
			<div id="site-info" class="col-md-9 col-xs-12">
				<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<?php bloginfo( 'name' ); ?>
                                ...
                                <paper-icon-button id='arctos-link' iconSrc="<?php echo get_template_directory_uri(); ?>/images/icons/arctos/arctos.svg" onclick="openLink('http://arctos.database.museum/')"></paper-icon-button>
